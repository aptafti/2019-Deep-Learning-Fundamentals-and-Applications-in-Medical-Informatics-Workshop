...
2) Within your <strong>Google Drive</strong>, please make a folder namely "<strong>chestimage</strong>". Upload the .ZIP file of the dataset (training_validation_2000.zip) under the "<strong>chestimage</strong>" directory within your <strong>Google Drive</strong>.
